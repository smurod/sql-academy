...
@section('title', 'Добавление модуля — SQLMastery Admin')
...
@section('page-header')
    <div>
        ...
        <h1 class="admin-page-title">Добавление <span>модуля</span></h1>
        <p class="admin-page-subtitle">
            Создайте новый учебный модуль, укажите его название, slug, порядок и описание.
        </p>
    </div>
@endsection
    ...
    <div class="admin-form-page">
        <div class="admin-form-card">
            <div class="admin-form-head">
                <h2>Новый модуль</h2>
                <p>Заполните основную информацию для создания нового учебного модуля.</p>
            </div>
            ...
            <div class="admin-side-body">
                ...
                <div class="admin-side-list">
                    <div class="admin-side-item">
                        ...
                        <div>
                            <strong>Понятное название</strong>
                            <span>Название модуля должно сразу отражать тему и быть удобным для навигации по курсу.</span>
                        </div>
                    </div>
                    ...
                    <div class="admin-side-item">
                        ...
                        <div>
                            <strong>Slug</strong>
                            <span>Используйте короткий и понятный slug без пробелов и специальных символов.</span>
                        </div>
                    </div>
                    ...
                    <div class="admin-side-item">
                        ...
                        <div>
                            ...
                            <span>Порядковый номер определяет позицию модуля в общей структуре курса.</span>
                        </div>
                    </div>
                    ...
                    <div class="admin-side-item">
                        ...
                        <div>
                            ...
                            <span>Добавьте краткое описание, чтобы было понятно, чему посвящён модуль.</span>
                        </div>
                    </div>
                </div>
            </div>
