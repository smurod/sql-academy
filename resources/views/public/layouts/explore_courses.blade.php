    ...
    <div class="container">
        <div class="section-heading text-center style-flex gap-24">
            ...
            <div class="section-heading__content">
                <p class="section-heading__desc text-start mt-0 text-line-2 wow bounceInUp">Welcome to our diverse and dynamic course catalog. we're dedicated to providing you...</p>
