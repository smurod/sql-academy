...
<head>
    ...
    <title>Подтверждение пароля — SQL Academy</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        :root {
            ...
            --bg-dark: #0a0a1a; --bg-card: #111127; --bg-elevated: #1a1a35;
        ...
        .particle {
            position: absolute; width: 4px; height: 4px; background: var(--warning);
        ...
        @keyframes pulse-glow {
            ...
            50% { box-shadow: 0 15px 40px rgba(239,68,68,0.3); }
        }

        .auth-icon i { font-size: 1.5rem; color: white; }
        .auth-header h1 { font-size: 1.5rem; font-weight: 800; letter-spacing: -0.03em; margin-bottom: 0.75rem; }
        ...
        .auth-submit:hover { transform: translateY(-3px); box-shadow: 0 15px 40px rgba(245,158,11,0.4); }
...
<div class="auth-layout">
    <div class="auth-wrapper">
        ...
        <div class="auth-card">
            ...
            <div class="auth-desc">
                Это защищённая область приложения. Пожалуйста, подтвердите свой пароль перед продолжением.
            </div>
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="auth-form">
                ...
                <button type="submit" class="auth-submit">
                    <i class="bi bi-shield-check"></i> Подтвердить
                </button>
            </form>
        </div>
