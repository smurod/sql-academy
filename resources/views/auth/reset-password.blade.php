...
<head>
    ...
    <title>Сброс пароля — SQL Academy</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .particle {
            position: absolute; width: 4px; height: 4px; background: var(--success);
        ...
        @keyframes pulse-glow {
            0%, 100% { box-shadow: 0 10px 30px rgba(34,197,94,0.3); }
        ...
        .auth-submit:hover { transform: translateY(-3px); box-shadow: 0 15px 40px rgba(34,197,94,0.4); }
        ...
        <div class="auth-card">
            ...
            <form method="POST" action="{{ route('password.store') }}" class="auth-form">
                ...
                <button type="submit" class="auth-submit">
                    <i class="bi bi-check-circle-fill"></i> Сбросить пароль
                </button>
            </form>
        </div>

        <div class="auth-back">
            <a href="{{ route('login') }}"><i class="bi bi-arrow-left"></i> Вернуться ко входу</a>
        </div>
    </div>
</div>
